"use strict";
$("#top-content div.arrow-icon").click(function () {
    $('html, body').animate({
        scrollTop: $("#services").offset().top
    }, 900, );
});
/* $('#emailForm button[type=submit]').on('click', function(){
    
         $('#emailForm div.signin-signup-form').fadeOut(1000);
     $('#emailForm div#ty').delay(1000).fadeIn(1000);
 });*/
$('#emailForm button[type=submit]').on('click', function () {
